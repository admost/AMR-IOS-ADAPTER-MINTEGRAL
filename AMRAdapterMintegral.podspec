Pod::Spec.new do |s|
  ...
  s.dependency 'MintegralAdSDK/NativeAd', '7.0.4'
  s.dependency 'MintegralAdSDK/InterstitialVideoAd', '7.0.4'
  s.dependency 'MintegralAdSDK/RewardVideoAd', '7.0.4'
  s.dependency 'MintegralAdSDK/InterstitialAd', '7.0.4'
